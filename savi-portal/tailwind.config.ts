...
/**
 * Tailwind CSS configuration for SAVI Portal
 * Uses a modern, professional color palette with warm accents
 */
const config: Config = {
  content: [
  ...
  theme: {
    extend: {
      colors: {
        // Primary brand colors - Deep teal for trust and professionalism
        primary: {
          50: "#e6f7f7",
          100: "#b3e6e6",
          200: "#80d5d5",
