...
/// <summary>
/// Validator for UpdateAdvertiserCommand.
/// </summary>
public sealed class UpdateAdvertiserValidator : AbstractValidator<UpdateAdvertiserCommand>
{
    public UpdateAdvertiserValidator()
    {
