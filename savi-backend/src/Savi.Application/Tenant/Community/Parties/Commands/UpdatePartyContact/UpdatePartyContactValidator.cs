...
/// <summary>
/// Validator for UpdatePartyContactCommand.
/// </summary>
public class UpdatePartyContactValidator : AbstractValidator<UpdatePartyContactCommand>
{
    public UpdatePartyContactValidator()
    {
        RuleFor(x => x.PartyId)
            .NotEmpty()
