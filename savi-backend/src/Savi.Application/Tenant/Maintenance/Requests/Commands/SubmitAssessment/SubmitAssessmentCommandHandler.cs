...
/// <summary>
/// Handler for submitting a site visit assessment.
/// </summary>
public class SubmitAssessmentCommandHandler
    : IRequestHandler<SubmitAssessmentCommand, Result>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return Result.Failure("Assessment summary is required.");
        }

        maintenanceRequest.RecordAssessment(
